...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.roseShader.init();
        this.roseShader.setUniformf("resolution", this.width * 2, this.height * 2);
        this.roseShader.setUniformf("time", (float)(System.currentTimeMillis() - 0L) / 1000.0f);
        ShaderUtil.drawQuads(roseX - 25.0f, roseY - (25.0f + roseMovement), buttonWH + 50.0f, buttonWH + 50.0f);
        this.roseShader.unload();
