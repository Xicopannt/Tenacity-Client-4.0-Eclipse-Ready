...
IPlayerUsage {
    ...
    public Minecraft(GameConfiguration gameConfig) {
        ...
        Proxy proxy = this.proxy = gameConfig.userInfo.proxy == null ? Proxy.NO_PROXY : gameConfig.userInfo.proxy;
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        Tenacity.INSTANCE.getModuleCollection().init();
        SplashScreen.init();
   ...
   //     Tenacity.INSTANCE.getConfigManager().loadDefaultConfig();
    ...
    private void checkGLError(String message) {
        ...
        if (!enableGLErrorChecking) return;
    ...
    public void runTick() throws IOException {
        Client.dispatchEvent(new TickEvent(this.ticks));
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (this.theWorld != null) {
            WorldEvent.Unload e = new WorldEvent.Unload(this.theWorld);
    ...
    public PropertyMap getProfileProperties() {
        if (!this.profileProperties.isEmpty()) return this.profileProperties;
