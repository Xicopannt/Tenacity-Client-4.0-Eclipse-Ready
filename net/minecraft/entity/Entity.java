...
implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            boolean bl = flag = this.onGround && (this.isSneaking() || safeWalkEvent.isSafe()) && this instanceof EntityPlayer;
            if (flag) {
                double d6 = 0.05;
    ...
    public boolean isInRangeToRenderDist(double distance) {
        ...
        if (!Double.isNaN(d0)) return distance < (d0 = d0 * 64.0 * this.renderDistanceWeight) * d0;
        d0 = 1.0;
