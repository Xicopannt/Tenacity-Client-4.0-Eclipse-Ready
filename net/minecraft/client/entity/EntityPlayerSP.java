...
import dev.event.impl.player.JumpEvent;
import dev.event.impl.player.MotionEvent;
import dev.event.impl.player.MoveEvent;
import dev.event.impl.player.PushOutOfBlockEvent;
...
extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        MotionEvent motionEvent = new MotionEvent(Event.Type.PRE, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
        Client.dispatchEvent(motionEvent);
        double posX = motionEvent.getX();
        double posY = motionEvent.getY();
        double posZ = motionEvent.getZ();
        float rotationYaw = motionEvent.getYaw();
        float rotationPitch = motionEvent.getPitch();
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        if (this.noClip) {
            if (pushOutOfBlockEvent.isCancelled()) return false;
        }
